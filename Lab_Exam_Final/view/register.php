...
<body>
    ...
    <script>
        function createAccount(){
            ...
            if(username == ''){
                document.getElementById('status_message').innerHTML = "Fill Username";
            }else if(password == ''){
                document.getElementById('status_message').innerHTML = "Fill Password";
            }else if(name == ''){
                document.getElementById('status_message').innerHTML = "Fill Name";
            }else if(contact == ''){
                document.getElementById('status_message').innerHTML = "Fill Contact Number";
            }else{
